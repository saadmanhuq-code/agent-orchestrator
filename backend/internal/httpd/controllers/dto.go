...
type SwitchAgentRequest struct {
	TargetHarness  domain.AgentHarness `json:"targetHarness" enum:"claude-code,codex,kimi" description:"Agent harness to continue the logical AO session with. kimi is accepted for Chat-mode sessions only."`
